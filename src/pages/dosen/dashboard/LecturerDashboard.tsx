  ...
  return (
    <div className="w-full space-y-6 pb-20">
      ...
      >
        ...
        {/* Scholar & Scopus Cards Row (Redesigned & Minimal) */}
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          
          {/* Google Scholar Card */}
          <div className="flex flex-col justify-between rounded-2xl border border-hairline-light bg-surface-light-raised p-4 sm:p-5 dark:border-hairline-dark dark:bg-surface-dark-elevated">
            <div>
              {/* Card Header: Icon, Info, Status & Profile Link */}
              <div className="flex items-start justify-between gap-3 mb-3.5">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-blue-200/60 bg-blue-50/80 text-chart-scholar dark:border-blue-900/40 dark:bg-blue-950/30 dark:text-chart-scholar-dark">
                    <BookOpen className="h-5 w-5" />
                  </div>
                  <div className="min-w-0">
                    <h3 className="text-sm font-bold tracking-tight text-ink-heading dark:text-on-dark truncate">
                      Google Scholar
                    </h3>
                    {activeUser?.scholar_id ? (
                      <p className="text-xs font-mono text-muted dark:text-on-dark-muted truncate">
                        ID: {activeUser.scholar_id}
                      </p>
                    ) : (
                      <p className="text-xs text-muted-soft dark:text-on-dark-muted">
                        Belum dikonfigurasi
                      </p>
                    )}
                  </div>
              ...
              <phantom-ui loading={loading && !profileData} animation="shimmer" className="block">
                {scholarData ? (
                  <div className="grid grid-cols-3 gap-2 sm:gap-2.5">
                    <div className="rounded-xl border border-hairline-light bg-surface-light p-2.5 text-center dark:border-hairline-dark dark:bg-surface-dark">
                      <span className="block text-[10px] font-semibold uppercase tracking-wider text-muted dark:text-on-dark-muted">
                        Dokumen
                      </span>
                      <span className="mt-0.5 block text-lg font-bold font-mono tracking-tight text-ink-heading dark:text-on-dark tabular-nums">
                  ...
                  <div className="flex items-center justify-center gap-2 py-4 px-3 text-center rounded-xl border border-dashed border-hairline-light bg-surface-light dark:border-hairline-dark dark:bg-surface-dark">
                    <BookOpen className="h-4 w-4 text-muted dark:text-on-dark-muted shrink-0" />
            ...
            {scholarData?.last_synced && (
              <div className="text-[10px] font-mono text-muted dark:text-on-dark-muted text-right mt-2.5">
          ...
          <div className="flex flex-col justify-between rounded-2xl border border-hairline-light bg-surface-light-raised p-4 sm:p-5 dark:border-hairline-dark dark:bg-surface-dark-elevated">
            <div>
              ...
              <div className="flex items-start justify-between gap-3 mb-3.5">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-orange-200/60 bg-orange-50/80 text-chart-scopus dark:border-orange-900/40 dark:bg-orange-950/30 dark:text-chart-scopus-dark">
              ...
              <phantom-ui loading={loading && !profileData} animation="shimmer" className="block">
                {scopusData ? (
                  ...
                  <div className="flex items-center justify-center gap-2 py-4 px-3 text-center rounded-xl border border-dashed border-hairline-light bg-surface-light dark:border-hairline-dark dark:bg-surface-dark">
                    <Globe className="h-4 w-4 text-muted dark:text-on-dark-muted shrink-0" />
                    <p className="text-xs text-muted dark:text-on-dark-muted">Belum ada data terhubung</p>
                  </div>
                )}
              </phantom-ui>
        ...
        <div className="space-y-2.5">
          ...
          <div className="h-2 w-full rounded-full bg-surface-light-raised dark:bg-surface-dark-elevated overflow-hidden flex border border-hairline-light dark:border-hairline-dark">
            {internalPct > 0 && (
              <div
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 text-xs text-muted dark:text-on-dark-muted pt-1">
