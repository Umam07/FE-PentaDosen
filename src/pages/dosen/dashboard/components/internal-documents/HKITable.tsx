      ...
      <div className="hidden md:block w-full overflow-x-auto">
        <table className="min-w-full divide-y divide-hairline-light dark:divide-hairline-dark text-xs">
          <thead className="bg-surface-light-raised dark:bg-surface-dark-elevated border-b border-hairline-light dark:border-hairline-dark">
            <tr>
              <th className="px-6 py-3.5 text-left text-xs font-semibold text-body dark:text-on-dark-soft">Informasi HKI</th>
              <th className="hidden lg:table-cell px-6 py-3.5 text-left text-xs font-semibold text-body dark:text-on-dark-soft">Kategori HKI</th>
              <th className="hidden md:table-cell px-6 py-3.5 text-left text-xs font-semibold text-body dark:text-on-dark-soft">Tanggal Perolehan</th>
