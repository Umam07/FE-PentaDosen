            ...
            <div key={doc.id || idx} className="p-4 space-y-3 bg-white dark:bg-zinc-900">
              ...
              <div className="flex flex-wrap items-center gap-1.5 text-[10px]">
                ...
                {Number(doc.dana_disetujui || 0) > 0 && (
                  <span className="px-2 py-0.5 rounded-md bg-emerald-50 dark:bg-emerald-950/20 text-emerald-600 dark:text-emerald-400 font-bold border border-emerald-200/50">
