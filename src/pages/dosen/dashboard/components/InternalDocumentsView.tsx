            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {categoryFilter === 'penelitian' ? (
                      ...
                      <table className="min-w-full divide-y divide-slate-50 dark:divide-slate-800 text-sm">
                        <thead className="bg-slate-50/50 dark:bg-slate-800/30">
                          <tr>
                            ...
                            <th className="hidden md:table-cell px-6 py-4 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">
                              Tahun
                            </th>
                            <th className="hidden sm:table-cell px-6 py-4 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">
                              Status
                            </th>
                  ...
                  /* ── Card layout untuk kategori lain ── */
                  <>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <h3 className="text-sm font-black text-slate-800 dark:text-slate-200 leading-snug line-clamp-1">
                                {doc.title}
                              </h3>
                            </div>
