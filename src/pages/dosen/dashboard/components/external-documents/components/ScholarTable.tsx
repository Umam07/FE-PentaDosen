                  ...
                  >
                    ...
                    <td className="hidden lg:table-cell px-6 py-4">
                      <div className="space-y-1">
                        <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold text-[10px] border border-slate-200/60 dark:border-slate-700/60">
                          Google Scholar
                        </span>
                        {isAlsoScopus && (
                          <div>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="space-y-1">
                        <span className="text-xs font-bold font-mono text-slate-900 dark:text-white tabular-nums">
                          +{Math.round(docPoints)} <span className="text-[11px] font-normal text-slate-500">Pts</span>
                        </span>
                        <button
                            ...
                            <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 space-y-3">
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60 flex justify-between items-center">
                                  <div>
                                    <span className="block text-xs text-slate-500 dark:text-slate-400">Dokumen GS</span>
                                    <span className="text-[11px] text-slate-400">Poin flat publikasi</span>
                                  </div>
                                  <span className="font-bold font-mono text-slate-900 dark:text-white">+0.50</span>
                                </div>
                                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60 flex justify-between items-center">
                                  <div>
                                    <span className="block text-xs text-slate-500 dark:text-slate-400">Bonus Tersitasi</span>
                                    <span className="text-[11px] text-slate-400">Jika sitasi &gt; 0</span>
                                  </div>
                                  <span className="font-bold font-mono text-slate-900 dark:text-white">{citations > 0 ? '+0.50' : '+0.00'}</span>
                                </div>
                                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60 flex justify-between items-center">
                                  <div>
                                    <span className="block text-xs text-slate-500 dark:text-slate-400">Poin Sitasi ({citations})</span>
                                    <span className="text-[11px] text-slate-400">0.25 pts / sitasi</span>
                                  </div>
                                  <span className="font-bold font-mono text-slate-900 dark:text-white">+{(Math.min(citations, 500) * 0.25).toFixed(2)}</span>
                                </div>
                              </div>
                            </div>
                          </motion.div>
            ...
            <div key={doc.id || idx} className="p-4 space-y-3 bg-white dark:bg-slate-900">
              ...
              <div className="flex items-center justify-between pt-1">
                <div className="text-xs">
                  <span className="text-slate-500 dark:text-slate-400">Poin Scholar: </span>
                  ...
                  >
                    <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-800 space-y-2 text-xs">
                      <div className="flex justify-between border-b border-slate-200/60 dark:border-slate-700 pb-1.5">
                        <span className="text-slate-500">Dokumen GS:</span>
                        <strong className="font-mono text-slate-900 dark:text-white">+0.50 pts</strong>
                      </div>
                      <div className="flex justify-between border-b border-slate-200/60 dark:border-slate-700 pb-1.5">
                        <span className="text-slate-500">Bonus Tersitasi:</span>
                        <strong className="font-mono text-slate-900 dark:text-white">{citations > 0 ? '+0.50 pts' : '+0.00 pts'}</strong>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-500">Poin Sitasi ({citations}):</span>
                        <strong className="font-mono text-slate-900 dark:text-white">+{(Math.min(citations, 500) * 0.25).toFixed(2)} pts</strong>
                      </div>
                    </div>
                  </motion.div>
                )}
