            ...
            <tr>
              ...
              <th className="px-6 py-4 text-left text-xs font-semibold text-body dark:text-on-dark-soft">
                <div className="flex flex-col items-start">
                  <span>Kategori</span>
                  <span className="text-[11px] font-normal text-muted dark:text-on-dark-muted">Peran Penulis</span>
                </div>
              </th>
              <th className="px-6 py-4 text-left text-xs font-semibold text-body dark:text-on-dark-soft">
                <div className="flex flex-col items-start">
                  ...
                  >
                    ...
                    <td className="px-6 py-4 align-top">
                      <div className="flex items-start gap-3">
                        <div className="p-2 bg-surface-light-raised dark:bg-surface-dark-elevated rounded-xl text-muted dark:text-on-dark-muted border border-hairline-light dark:border-hairline-dark flex-shrink-0 mt-0.5">
                          <Globe className="w-4 h-4 text-chart-scopus dark:text-chart-scopus-dark" />
                        </div>
                        <div className="min-w-0 max-w-xs sm:max-w-sm lg:max-w-md">
                          ...
                          <p className="text-[11px] text-muted dark:text-on-dark-muted mt-0.5 italic truncate max-w-[280px]">
                            {doc.source_name || doc.journal || 'Scopus Indexed'}
                          </p>
                        </div>
                      </div>
                    </td>

                    {/* 2. Kategori & Peran Penulis */}
                    <td className="px-6 py-4 align-top">
                      <div className="flex flex-col items-start gap-1.5">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          {bd.q && bd.q !== 'None' ? (
                            ...
                            <span className="px-2 py-0.5 bg-surface-light-raised dark:bg-surface-dark-elevated text-muted dark:text-on-dark-muted text-[10px] font-semibold rounded-md border border-hairline-light dark:border-hairline-dark">
                              Non-Q
                            </span>
                          )}
                    ...
                    <td className="px-6 py-4 align-top">
                      {!isPublic && showCorrespondingControls && !bd.isCorrespondingConfirmed ? (
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold bg-warning-soft dark:bg-warning/20 text-warning dark:text-warning-on-dark border border-warning-border dark:border-warning/30 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 align-top text-right">
                      <div className="flex flex-col items-end gap-1.5">
                        ...
                        <button
                          ...
                          title={isExpanded ? 'Tutup Rincian' : 'Lihat Rincian Perhitungan SINTA'}
                        >
            ...
            <div key={doc.id || idx} className="p-4 space-y-3 bg-surface-light dark:bg-surface-dark">
              ...
              <div className="flex items-center justify-between pt-1">
                <div className="flex items-center gap-2">
                  {!isPublic && showCorrespondingControls && !bd.isCorrespondingConfirmed ? (
                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full font-medium text-xs border bg-warning-soft dark:bg-warning/20 text-warning dark:text-warning-on-dark border-warning-border dark:border-warning/30">
                      <AlertTriangle className="w-3 h-3" /> Konfirmasi
                    </span>
                  ) : (
                  ...
                  >
                    <Globe className="w-3 h-3 text-chart-scopus dark:text-chart-scopus-dark" /> Scopus
                  </a>
                </div>
