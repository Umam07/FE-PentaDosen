  ...
  return (
    <section className="bg-surface-light dark:bg-surface-dark rounded-2xl border border-hairline-light dark:border-hairline-dark overflow-hidden shadow-2xs">
      <div className="p-5 border-b border-hairline-light dark:border-hairline-dark bg-surface-light dark:bg-surface-dark">
        <h2 className="text-base font-bold text-ink-heading dark:text-on-dark tracking-tight">Riwayat Dokumen HKI</h2>
      </div>
      ...
      <div className="w-full overflow-x-auto">
        <table className="min-w-full divide-y divide-hairline-light-soft dark:divide-hairline-dark-soft text-xs">
          <thead className="bg-surface-light-raised dark:bg-surface-dark-elevated/40 border-b border-hairline-light dark:border-hairline-dark">
            <tr>
              <th className="px-6 py-3.5 text-left text-xs font-semibold text-muted dark:text-on-dark-muted">Informasi HKI</th>
              <th className="hidden lg:table-cell px-6 py-3.5 text-left text-xs font-semibold text-muted dark:text-on-dark-muted">Kategori HKI</th>
              <th className="hidden md:table-cell px-6 py-3.5 text-left text-xs font-semibold text-muted dark:text-on-dark-muted">Tanggal Perolehan</th>
