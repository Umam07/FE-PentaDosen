...
export default function HKIHeader({ onOpenMetricsModal }: HKIHeaderProps) {
  return (
    <motion.div
    ...
    >
      <div className="flex items-start gap-2.5">
        ...
        <p className="text-xs font-medium text-indigo-900 dark:text-indigo-200 leading-relaxed">
          <span className="font-bold">Pengelolaan Hak Kekayaan Intelektual:</span> Daftarkan Paten, Merk, dan Hak Cipta Anda pada halaman ini.
        </p>
      </div>
      ...
      {onOpenMetricsModal && (
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white rounded-xl text-[10px] font-black uppercase tracking-wider shadow-sm transition-all whitespace-nowrap self-start sm:self-auto shrink-0"
        >
