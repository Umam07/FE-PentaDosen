          ...
          >
            <div className="p-6 sm:p-8">
              <div className="flex items-center gap-3.5 mb-6">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white tracking-tight">Hubungkan ke Penelitian</h3>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Pilih penelitian asal yang melandasi perolehan HKI ini</p>
                </div>
              </div>
