...
import { Upload, Download, FileSpreadsheet, AlertTriangle, Sparkles, CheckCircle2 } from 'lucide-react';
...
interface ScopusFiltersBarProps {
  ...
  isImporting: boolean;
  showFilters?: boolean;
  // Props konfirmasi korespondensi terintegrasi
  unconfirmedDocs?: any[];
...
export const ScopusFiltersBar: React.FC<ScopusFiltersBarProps> = ({
  ...
  return (
    <div className="bg-surface-light dark:bg-surface-dark border border-hairline-light dark:border-hairline-dark rounded-2xl sm:rounded-3xl p-4 sm:p-5 space-y-4 shadow-2xs">
      ...
      {/* Strip Konfirmasi Korespondensi Terintegrasi */}
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pt-3 border-t border-hairline-light-soft dark:border-hairline-dark-soft">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <span className="text-xs text-body-strong dark:text-on-dark truncate">
              <strong className="font-bold text-ink-heading dark:text-on-dark font-mono">{unconfirmedDocs.length}</strong> publikasi perlu konfirmasi status korespondensi
            </span>
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end shrink-0">
            ...
            >
              {isSettingAllFalse ? (
                ...
                <>
                  ...
                  <span>Set Semua: Bukan Corresponding</span>
                </>
              )}
            </button>
            ...
            >
              ...
              <span>Konfirmasi Massal ({unconfirmedDocs.length})</span>
            </button>
          </div>
        </div>
      )}
