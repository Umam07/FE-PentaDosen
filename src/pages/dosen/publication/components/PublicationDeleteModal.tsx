        ...
        <div className="fixed inset-0 z-[9000] flex items-center justify-center p-4">
          ...
          >
            <div className="flex flex-col items-center text-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200/60 dark:border-rose-900/40 flex items-center justify-center text-rose-600 dark:text-rose-400">
                <Trash2 className="w-6 h-6" />
              </div>
              <div>
                <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">Hapus Publikasi?</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Tindakan ini tidak dapat dibatalkan.</p>
              </div>
              <div className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200/80 dark:border-slate-700/80 text-left">
                <p className="text-xs font-bold text-slate-900 dark:text-white line-clamp-2">{deleteDoc.title}</p>
                <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">{deleteDoc.category}</p>
              </div>
