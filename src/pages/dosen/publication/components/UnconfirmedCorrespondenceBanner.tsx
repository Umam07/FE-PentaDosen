...
export default function UnconfirmedCorrespondenceBanner({
  ...
  return (
    <motion.div
      ...
      className={
        isNationalJournal
          ? "bg-blue-50/70 dark:bg-blue-950/30 border border-blue-200/80 dark:border-blue-800/50 rounded-2xl px-4 py-3 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-3"
          : "bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200/80 dark:border-amber-800/50 rounded-2xl px-4 py-3 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-3"
      }
    >
        ...
        <AlertTriangle
          className={
            isNationalJournal
              ...
              : "w-4 h-4 text-amber-600 dark:text-amber-400 shrink-0"
          }
        />
        <span
          className={
            isNationalJournal
              ? "text-xs font-semibold text-blue-950 dark:text-blue-200 truncate"
              : "text-xs font-semibold text-amber-950 dark:text-amber-200 truncate"
          }
        >
          {isNationalJournal ? (
            <>
      ...
      <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto justify-end">
        <button
          ...
          className={
            isNationalJournal
              ? "inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-semibold shadow-xs transition-all active:scale-95 disabled:opacity-50 whitespace-nowrap cursor-pointer"
              : "inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-xs font-semibold shadow-xs transition-all active:scale-95 disabled:opacity-50 whitespace-nowrap cursor-pointer"
          }
        ...
        <button
          ...
          className={
            isNationalJournal
              ? "inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-white dark:bg-slate-900 hover:bg-blue-50 dark:hover:bg-slate-800 text-blue-950 dark:text-blue-200 border border-blue-200 dark:border-blue-800 rounded-xl text-xs font-semibold shadow-2xs transition-all active:scale-95 whitespace-nowrap cursor-pointer"
              : "inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-white dark:bg-slate-900 hover:bg-amber-50 dark:hover:bg-slate-800 text-amber-950 dark:text-amber-200 border border-amber-200 dark:border-amber-800 rounded-xl text-xs font-semibold shadow-2xs transition-all active:scale-95 whitespace-nowrap cursor-pointer"
          }
        >
