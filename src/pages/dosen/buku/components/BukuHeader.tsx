    ...
    >
      ...
      <div className="flex items-start sm:items-center gap-3 min-w-0">
        <div className="p-2.5 bg-slate-100 dark:bg-slate-800 rounded-2xl text-slate-700 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700/80 shrink-0">
          <Book className="w-5 h-5 text-slate-700 dark:text-slate-300" />
        </div>
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700/80 uppercase tracking-wider">
              Dokumen Internal
            </span>
          </div>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 truncate">
            Registrasikan Buku Referensi, Buku Ajar, dan Monograf Anda pada halaman ini.
          </p>
        </div>
      </div>
