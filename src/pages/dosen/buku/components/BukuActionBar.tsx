    ...
    >
      <div className="flex items-center gap-3.5 w-full lg:w-auto">
        ...
        <div className="min-w-0 flex-1">
          <h2 className="text-sm sm:text-base font-bold text-ink-heading dark:text-on-dark tracking-tight">Kelola Buku Referensi & Ajar</h2>
          <p className="text-xs text-muted dark:text-on-dark-muted mt-0.5">Registrasikan buku baru atau impor data dari Excel secara massal</p>
        </div>
      </div>
