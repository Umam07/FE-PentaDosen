          ...
          >
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-gray-400 dark:text-zinc-500 mt-1">
                  Tindakan ini tidak dapat dibatalkan.
                </p>
              </div>
              <div className="w-full px-4 py-3 bg-gray-50 dark:bg-zinc-800 rounded-xl border border-gray-100 dark:border-zinc-700">
                <p className="text-xs font-black text-gray-700 dark:text-zinc-300 uppercase tracking-tight">
