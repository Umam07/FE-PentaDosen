...
export default function ResearchActionBar({
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-slate-900 shadow-xs rounded-2xl sm:rounded-3xl border border-slate-200/80 dark:border-slate-800 p-5 sm:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-5 sm:gap-6"
    >
      <div className="flex items-center gap-3.5 w-full md:w-auto">
        ...
        <div>
          <h3 className="text-sm sm:text-base font-bold text-slate-900 dark:text-white tracking-tight">Kelola Hasil Penelitian</h3>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
            Registrasikan penelitian baru atau impor data dari Excel secara massal
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full md:w-auto justify-end">
        <button
          ...
          className="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2.5 bg-slate-900 hover:bg-slate-800 dark:bg-zinc-100 dark:hover:bg-white dark:text-zinc-900 text-white rounded-xl text-xs font-semibold shadow-xs transition-all active:scale-95 cursor-pointer"
        >
