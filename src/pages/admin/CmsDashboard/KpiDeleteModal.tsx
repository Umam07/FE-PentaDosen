        ...
        <div className="fixed inset-0 z-[9000] flex items-center justify-center p-4">
          ...
          >
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-black text-gray-900 dark:text-zinc-100 uppercase tracking-tight">Hapus Kategori KPI?</h3>
              ...
              <div className="w-full px-4 py-3 bg-gray-50 dark:bg-zinc-800 rounded-xl border border-gray-100 dark:border-zinc-700">
                <p className="text-xs font-black text-gray-700 dark:text-zinc-300 uppercase tracking-tight">{category}</p>
              </div>
