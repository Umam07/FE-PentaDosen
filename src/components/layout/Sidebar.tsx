      ...
      <div className={`h-16 lg:h-18 flex items-center flex-shrink-0 transition-all duration-300 ${isCollapsed && !isMobile ? 'justify-center px-2' : 'justify-between px-4'}`}>
        {!isCollapsed || isMobile ? (
          <>
            <Link 
              to="/dashboard" 
              className="flex items-center gap-2.5 group whitespace-nowrap min-w-0 p-1.5 -ml-1.5 rounded-xl hover:bg-surface-light-raised dark:hover:bg-surface-dark-elevated transition-colors" 
              aria-label="Dashboard PentaDosen" 
              title="Universitas YARSI • PentaDosen"
            >
