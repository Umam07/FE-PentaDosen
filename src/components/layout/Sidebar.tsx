...
import { Hexagon, PanelLeftOpen, PanelLeftClose, X } from 'lucide-react';
...
export default function Sidebar({
  ...
  return (
    ...
    >
      {/* Brand & Toggle Button */}
      <div className="h-20 lg:h-24 flex items-center justify-between px-6">
      ...
      <div className={`mb-4 flex-1 ${isCollapsed && !isMobile ? 'px-2' : 'px-4'}`}>
